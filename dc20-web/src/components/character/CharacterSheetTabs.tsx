...
function WeaponAttackCard({ item, modifier, adjustment, damageBonus, heavyHitDamageBonus, trained, prone, canUseVersatileTwoHanded, canReload, availableAP, availableSP, onReload, onSpendEnhancements, onThrown, onRoll }: {
