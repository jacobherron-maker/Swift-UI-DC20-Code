...
const RulesView: React.FC<{ preset?: 'all' | 'character-options'; focusRequest?: ContentFocusRequest | null; onFocusHandled?: () => void }> = ({ preset = 'all', focusRequest, onFocusHandled }) => {
